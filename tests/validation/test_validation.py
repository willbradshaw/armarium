"""Public fixtures are built in temporary vaults; no Obsidian or private data."""
...
from validation.parsing import parse_page
...
class VaultTests(unittest.TestCase):
    ...
    def template(self, kind, path, replacements=()):
    ...
    def assertRule(self, rule, path=None, field=None):
        errors = self.errors()
    ...
    def test_starter_copy_cli_read_only_and_external_cwd(self):
    ...
    def test_populated_entities_and_links(self):
        self.session()
    ...
    def test_campaign_ids_beyond_one(self):
    ...
    def test_empty_values_and_root_entities(self):
    ...
    def test_hidden_symlinks_and_gitkeep_ignored(self):
    ...
    def test_required_directories(self):
        for directory in ("world/npcs", "campaign_1/sessions", "assets", "templates"):
            with self.subTest(directory=directory):
                backup = Path(self.temp.name) / "backup"
                shutil.move(self.vault / directory, backup)
                self.assertRule("structure.directory", directory)
                shutil.move(backup, self.vault / directory)
        shutil.rmtree(self.vault / "campaign_1")
        self.assertRule("structure.campaign")

    def test_yaml_errors_survive_discovery_and_scan_continues(self):
    ...
    def test_duplicate_reports_line(self):
        _, errors = parse_page("note.md", "---\na: 1\na: 2\n---\n")
        self.assertEqual(errors[0].line, 3)

    def test_missing_type_and_required_fields(self):
    ...
    def test_known_field_shapes(self):
    ...
    def test_campaign_state_fields(self):
    ...
    def test_link_resolution_failures(self):
    ...
    def test_link_kinds_and_status_applicability(self):
    ...
    def test_malformed_and_table_links(self):
    ...
    def test_code_examples_versus_executable_links(self):
    ...
    def test_body_missing_order_and_nested_content(self):
    ...
    def test_identity_and_placement(self):
        self.session()
    ...
    def test_actual_session_empty_alias_item_is_invalid(self):
    ...
    def test_cross_campaign_identity(self):
    ...
    def test_templates_definitions_and_session_order(self):
    ...
    def test_link_lists_and_type_must_be_canonical(self):
    ...
    def test_invalid_encoding_does_not_stop_scan(self):
    ...
    def test_invalid_root_cli(self):
